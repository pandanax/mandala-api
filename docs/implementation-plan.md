...
> **Архив.** Этот документ фиксирует поэтапную реализацию (тикеты 1–24) для истории репозитория и контекста ИИ-агентов. **Актуальная** навигация по продукту: корневой [README](../README.md), [getting-started.md](getting-started.md), [roadmap.md](roadmap.md).
