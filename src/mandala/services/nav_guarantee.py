...
def _astrology_fallback_buttons() -> list[list[dict[str, str]]]:
    """Контентная навигация astrology: натальная карта / прогноз / профиль."""
    return [
        [_btn("🔮 Натальная карта", "mdl:natal"), _btn("📊 Прогноз", "mdl:forecast_menu")],
        [_btn("🌌 Сферы жизни", "mdl:th_personality"), _btn("👤 Профиль", "mdl:profile")],
    ]
